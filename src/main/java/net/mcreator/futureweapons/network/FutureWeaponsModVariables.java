...
public class FutureWeaponsModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		FutureWeaponsMod.addNetworkMessage(SavedDataSyncMessage.class, SavedDataSyncMessage::buffer, SavedDataSyncMessage::new, SavedDataSyncMessage::handler);
	...
	public static class EventBusVariableHandlers {
		...
		public static void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
			if (!event.getEntity().level().isClientSide()) {
				...
				if (mapdata != null)
					FutureWeaponsMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayer) event.getEntity()), new SavedDataSyncMessage(0, mapdata));
				if (worlddata != null)
					FutureWeaponsMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayer) event.getEntity()), new SavedDataSyncMessage(1, worlddata));
			}
		}
	...
	public static class WorldVariables extends SavedData {
		public static final String DATA_NAME = "future_weapons_worldvars";
		...
		public void syncData(LevelAccessor world) {
			...
			if (world instanceof Level level && !level.isClientSide())
				FutureWeaponsMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(level::dimension), new SavedDataSyncMessage(1, this));
		}
	...
	public static class MapVariables extends SavedData {
		public static final String DATA_NAME = "future_weapons_mapvars";
		public String choice21 = "";
		public String choice22 = "\"\"";
		...
		public void read(CompoundTag nbt) {
			choice21 = nbt.getString("choice21");
			choice22 = nbt.getString("choice22");
		}

		@Override
		public CompoundTag save(CompoundTag nbt) {
			nbt.putString("choice21", choice21);
			nbt.putString("choice22", choice22);
			return nbt;
		}
		...
		public void syncData(LevelAccessor world) {
			...
			if (world instanceof Level && !world.isClientSide())
				FutureWeaponsMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new SavedDataSyncMessage(0, this));
		}
