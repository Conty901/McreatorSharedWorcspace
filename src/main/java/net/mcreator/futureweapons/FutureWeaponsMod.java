package net.mcreator.futureweapons;
...
import net.mcreator.futureweapons.init.FutureWeaponsModTabs;
...
@Mod("future_weapons")
public class FutureWeaponsMod {
	public static final Logger LOGGER = LogManager.getLogger(FutureWeaponsMod.class);
	public static final String MODID = "future_weapons";

	public FutureWeaponsMod() {
		...
		FutureWeaponsModMobEffects.REGISTRY.register(bus);

		FutureWeaponsModParticleTypes.REGISTRY.register(bus);

		FutureWeaponsModMenus.REGISTRY.register(bus);
