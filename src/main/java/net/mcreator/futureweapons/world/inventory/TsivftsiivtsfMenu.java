...
public class TsivftsiivtsfMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TsivftsiivtsfMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FutureWeaponsModMenus.TSIVFTSIIVTSF.get(), id);
