...
public class FusGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FusGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(FutureWeaponsModMenus.FUS_GUI.get(), id);
